...
async function POST(req) {
    try {
        ...
        const exists = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$Models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
            email
        });
        if (exists) {
            return new Response(JSON.stringify({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3121d9a4._.js.map