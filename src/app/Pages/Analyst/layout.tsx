          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <p className="font-semibold text-sm">{user.name || "Analyst"}</p>
                <p className="text-xs text-blue-200">Analyste</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex justify-between items-center px-8 py-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <button className="relative p-3 hover:bg-gray-100 rounded-xl transition-all group">
                ...
                <Bell className="w-5 h-5 text-gray-600 group-hover:text-blue-900 transition-colors" />
              </button>
